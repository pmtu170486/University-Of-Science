...
namespace ASPMVC.EmployeeServices {
    ...
    public interface IEmployeeSer {
        ...
        ASPMVC.EmployeeServices.NhanVien[] getall();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmployeeSer/getall", ReplyAction="http://tempuri.org/IEmployeeSer/getallResponse")]
        System.Threading.Tasks.Task<ASPMVC.EmployeeServices.NhanVien[]> getallAsync();
        ...
        void create(ASPMVC.EmployeeServices.NhanVien nv);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmployeeSer/create", ReplyAction="http://tempuri.org/IEmployeeSer/createResponse")]
        System.Threading.Tasks.Task createAsync(ASPMVC.EmployeeServices.NhanVien nv);
        ...
        void update(ASPMVC.EmployeeServices.NhanVien nv);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmployeeSer/update", ReplyAction="http://tempuri.org/IEmployeeSer/updateResponse")]
        System.Threading.Tasks.Task updateAsync(ASPMVC.EmployeeServices.NhanVien nv);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEmployeeSerChannel : ASPMVC.EmployeeServices.IEmployeeSer, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EmployeeSerClient : System.ServiceModel.ClientBase<ASPMVC.EmployeeServices.IEmployeeSer>, ASPMVC.EmployeeServices.IEmployeeSer {
        ...
        public ASPMVC.EmployeeServices.NhanVien[] getall() {
            return base.Channel.getall();
        }
        
        public System.Threading.Tasks.Task<ASPMVC.EmployeeServices.NhanVien[]> getallAsync() {
            return base.Channel.getallAsync();
        }
        
        public void create(ASPMVC.EmployeeServices.NhanVien nv) {
            base.Channel.create(nv);
        }
        
        public System.Threading.Tasks.Task createAsync(ASPMVC.EmployeeServices.NhanVien nv) {
        ...
        public void update(ASPMVC.EmployeeServices.NhanVien nv) {
            base.Channel.update(nv);
        }
        
        public System.Threading.Tasks.Task updateAsync(ASPMVC.EmployeeServices.NhanVien nv) {
